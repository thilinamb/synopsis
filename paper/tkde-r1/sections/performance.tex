...
In order to minimize the data transfer between the Spark cluster and driver, a \texttt{count} action was performed after the SQL query and its result was retrieved at the client.
