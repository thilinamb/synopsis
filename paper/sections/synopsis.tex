...
\begin{figure}
    ...
    \caption{A simplified Synopsis instance with a three-plane hierarchy and sample query scope, leading to several metadata leaves. In production settings, a Synopsis will contain hundreds of thousands of vertices and edges.}
    \label{fig:synopsis}
\end{figure}
