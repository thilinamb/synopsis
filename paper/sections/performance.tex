...
A query funnel continously generates random queries and dispatch at their maximum possible rate.
Our setup included 40 Synopsis nodes and one of those nodes were acting as the conduit for each query.
