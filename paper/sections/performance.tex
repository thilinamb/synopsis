...
An artificial computation logic was used in place of regular \textsc{Synopsis} sketch update function to gain a better control over the throughtput of a \textsc{Synopsis} node.
