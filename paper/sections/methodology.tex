...
The objective of these constraints is to avoid oscillations in scaling activities; for instance, repetitively scaling out in the presence of memory pressure could result in overprovisioning, which would then lead to recurring downscaling.
...
%
\begin{figure*}
\subfloat[Scale out protocol]{
        \centering
        \label{fig:scale-out-protocol}
        \includegraphics[width=0.45\textwidth, valign=t]{figures/scale-out.pdf}
        \vphantom{\includegraphics[width=0.45\textwidth,valign=t]{figures/scale-in.pdf} } 
        }
\subfloat[Scale in protocol]{
        \centering
        \label{fig:scale-in-protocol}
        \includegraphics[width=0.45\textwidth,valign=t]{figures/scale-in.pdf} 
        }
