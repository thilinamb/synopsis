...
\begin{IEEEbiography}[{\includegraphics[width=0.9in,height=1.15in, clip,keepaspectratio]{./bio/thilina.jpg}}]{Thilina Buddhika}
...
\end{IEEEbiography}
\vspace{-2cm}
\begin{IEEEbiography}[{\includegraphics[width=0.9in,height=1.15in,clip,keepaspectratio]{./bio/matthew.jpg}}]{Matthew Malensek}
...
%
\vspace{-2cm}
\begin{IEEEbiography}[{\includegraphics[width=0.9in,height=1.15in,clip,keepaspectratio]{./bio/sangmi.jpg}}]{Sangmi Lee Pallickara}
...
%
\vspace{-2cm}
\begin{IEEEbiography}[{\includegraphics[width=0.9in,height=1.15in,clip,keepaspectratio]{./bio/shrideep.jpg}}]{Shrideep Pallickara}
