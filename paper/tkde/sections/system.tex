...
A stream partitioning scheme, based on the Geohash algorithm (described in Section \ref{sec:geohash}), is used to route packets to the appropriate sketchlet.
