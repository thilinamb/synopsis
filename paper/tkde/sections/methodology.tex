...
We use our gossiping subsystem to update parent sketchlets about the child's performance metrics, which is useful for scaling in as explained in Section~\ref{subsec:scaling-in}.
